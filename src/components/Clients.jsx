      ...
      <section className="brand-section reveal">
        ...
        <div className="logo-slider">
          <div className="logo-track left">
            <div className="logo"><img src="/assets/Images/1.jpg" /></div>
            <div className="logo"><img src="/assets/Images/2.png" /></div>
            <div className="logo"><img src="/assets/Images/3.jpg" /></div>
            <div className="logo"><img src="/assets/Images/4.jpg" /></div>
            <div className="logo"><img src="/assets/Images/5.jpg" /></div>
